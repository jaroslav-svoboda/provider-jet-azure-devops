...
import (
	...
	tf "github.com/microsoft/terraform-provider-azuredevops/azuredevops"
	"gopkg.in/alecthomas/kingpin.v2"
	ctrl "sigs.k8s.io/controller-runtime"
	"sigs.k8s.io/controller-runtime/pkg/log/zap"

	"github.com/crossplane-contrib/provider-jet-azuredevops/apis"
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-jet-azuredevops"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-jet-azuredevops",
	...
	kingpin.FatalIfError(controller.Setup(mgr, log, rl, setup, ws, pconfig.GetProvider(resourceMap), 1), "Cannot setup AzureDevOps controllers")
